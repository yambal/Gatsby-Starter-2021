...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.feature_image.relativePath'
  | 'childrenMarkdownRemark.frontmatter.feature_image.extension'
  | 'childrenMarkdownRemark.frontmatter.feature_image.size'
  | 'childrenMarkdownRemark.frontmatter.feature_image.prettySize'
  | 'childrenMarkdownRemark.frontmatter.feature_image.modifiedTime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.accessTime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.changeTime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.birthTime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.root'
  | 'childrenMarkdownRemark.frontmatter.feature_image.dir'
  | 'childrenMarkdownRemark.frontmatter.feature_image.base'
  | 'childrenMarkdownRemark.frontmatter.feature_image.ext'
  | 'childrenMarkdownRemark.frontmatter.feature_image.name'
  | 'childrenMarkdownRemark.frontmatter.feature_image.relativeDirectory'
  | 'childrenMarkdownRemark.frontmatter.feature_image.dev'
  | 'childrenMarkdownRemark.frontmatter.feature_image.mode'
  | 'childrenMarkdownRemark.frontmatter.feature_image.nlink'
  | 'childrenMarkdownRemark.frontmatter.feature_image.uid'
  | 'childrenMarkdownRemark.frontmatter.feature_image.gid'
  | 'childrenMarkdownRemark.frontmatter.feature_image.rdev'
  | 'childrenMarkdownRemark.frontmatter.feature_image.ino'
  | 'childrenMarkdownRemark.frontmatter.feature_image.atimeMs'
  | 'childrenMarkdownRemark.frontmatter.feature_image.mtimeMs'
  | 'childrenMarkdownRemark.frontmatter.feature_image.ctimeMs'
  | 'childrenMarkdownRemark.frontmatter.feature_image.atime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.mtime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.ctime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.birthtime'
  | 'childrenMarkdownRemark.frontmatter.feature_image.birthtimeMs'
  | 'childrenMarkdownRemark.frontmatter.feature_image.blksize'
  | 'childrenMarkdownRemark.frontmatter.feature_image.blocks'
  | 'childrenMarkdownRemark.frontmatter.feature_image.publicURL'
  | 'childrenMarkdownRemark.frontmatter.feature_image.childrenImageSharp'
  ...
  | 'childMarkdownRemark.frontmatter.feature_image.relativePath'
  | 'childMarkdownRemark.frontmatter.feature_image.extension'
  | 'childMarkdownRemark.frontmatter.feature_image.size'
  | 'childMarkdownRemark.frontmatter.feature_image.prettySize'
  | 'childMarkdownRemark.frontmatter.feature_image.modifiedTime'
  | 'childMarkdownRemark.frontmatter.feature_image.accessTime'
  | 'childMarkdownRemark.frontmatter.feature_image.changeTime'
  | 'childMarkdownRemark.frontmatter.feature_image.birthTime'
  | 'childMarkdownRemark.frontmatter.feature_image.root'
  | 'childMarkdownRemark.frontmatter.feature_image.dir'
  | 'childMarkdownRemark.frontmatter.feature_image.base'
  | 'childMarkdownRemark.frontmatter.feature_image.ext'
  | 'childMarkdownRemark.frontmatter.feature_image.name'
  | 'childMarkdownRemark.frontmatter.feature_image.relativeDirectory'
  | 'childMarkdownRemark.frontmatter.feature_image.dev'
  | 'childMarkdownRemark.frontmatter.feature_image.mode'
  | 'childMarkdownRemark.frontmatter.feature_image.nlink'
  | 'childMarkdownRemark.frontmatter.feature_image.uid'
  | 'childMarkdownRemark.frontmatter.feature_image.gid'
  | 'childMarkdownRemark.frontmatter.feature_image.rdev'
  | 'childMarkdownRemark.frontmatter.feature_image.ino'
  | 'childMarkdownRemark.frontmatter.feature_image.atimeMs'
  | 'childMarkdownRemark.frontmatter.feature_image.mtimeMs'
  | 'childMarkdownRemark.frontmatter.feature_image.ctimeMs'
  | 'childMarkdownRemark.frontmatter.feature_image.atime'
  | 'childMarkdownRemark.frontmatter.feature_image.mtime'
  | 'childMarkdownRemark.frontmatter.feature_image.ctime'
  | 'childMarkdownRemark.frontmatter.feature_image.birthtime'
  | 'childMarkdownRemark.frontmatter.feature_image.birthtimeMs'
  | 'childMarkdownRemark.frontmatter.feature_image.blksize'
  | 'childMarkdownRemark.frontmatter.feature_image.blocks'
  | 'childMarkdownRemark.frontmatter.feature_image.publicURL'
  | 'childMarkdownRemark.frontmatter.feature_image.childrenImageSharp'
...
type MarkdownRemarkFieldsEnum =
  ...
  | 'frontmatter.feature_image.relativePath'
  | 'frontmatter.feature_image.extension'
  | 'frontmatter.feature_image.size'
  | 'frontmatter.feature_image.prettySize'
  | 'frontmatter.feature_image.modifiedTime'
  | 'frontmatter.feature_image.accessTime'
  | 'frontmatter.feature_image.changeTime'
  | 'frontmatter.feature_image.birthTime'
  | 'frontmatter.feature_image.root'
  | 'frontmatter.feature_image.dir'
  | 'frontmatter.feature_image.base'
  | 'frontmatter.feature_image.ext'
  | 'frontmatter.feature_image.name'
  | 'frontmatter.feature_image.relativeDirectory'
  | 'frontmatter.feature_image.dev'
  | 'frontmatter.feature_image.mode'
  | 'frontmatter.feature_image.nlink'
  | 'frontmatter.feature_image.uid'
  | 'frontmatter.feature_image.gid'
  | 'frontmatter.feature_image.rdev'
  | 'frontmatter.feature_image.ino'
  | 'frontmatter.feature_image.atimeMs'
  | 'frontmatter.feature_image.mtimeMs'
  | 'frontmatter.feature_image.ctimeMs'
  | 'frontmatter.feature_image.atime'
  | 'frontmatter.feature_image.mtime'
  | 'frontmatter.feature_image.ctime'
  | 'frontmatter.feature_image.birthtime'
  | 'frontmatter.feature_image.birthtimeMs'
  | 'frontmatter.feature_image.blksize'
  | 'frontmatter.feature_image.blocks'
  | 'frontmatter.feature_image.publicURL'
  | 'frontmatter.feature_image.childrenImageSharp'
  | 'frontmatter.feature_image.childrenImageSharp.gatsbyImageData'
  | 'frontmatter.feature_image.childrenImageSharp.id'
  | 'frontmatter.feature_image.childrenImageSharp.children'
  | 'frontmatter.feature_image.childImageSharp.gatsbyImageData'
  | 'frontmatter.feature_image.childImageSharp.id'
  | 'frontmatter.feature_image.childImageSharp.children'
  | 'frontmatter.feature_image.childrenMarkdownRemark'
  | 'frontmatter.feature_image.childrenMarkdownRemark.id'
  | 'frontmatter.feature_image.childrenMarkdownRemark.excerpt'
  | 'frontmatter.feature_image.childrenMarkdownRemark.rawMarkdownBody'
  | 'frontmatter.feature_image.childrenMarkdownRemark.fileAbsolutePath'
  | 'frontmatter.feature_image.childrenMarkdownRemark.html'
  | 'frontmatter.feature_image.childrenMarkdownRemark.htmlAst'
  | 'frontmatter.feature_image.childrenMarkdownRemark.excerptAst'
  | 'frontmatter.feature_image.childrenMarkdownRemark.headings'
  | 'frontmatter.feature_image.childrenMarkdownRemark.timeToRead'
  | 'frontmatter.feature_image.childrenMarkdownRemark.tableOfContents'
  | 'frontmatter.feature_image.childrenMarkdownRemark.children'
  | 'frontmatter.feature_image.childMarkdownRemark.id'
  | 'frontmatter.feature_image.childMarkdownRemark.excerpt'
  | 'frontmatter.feature_image.childMarkdownRemark.rawMarkdownBody'
  | 'frontmatter.feature_image.childMarkdownRemark.fileAbsolutePath'
  | 'frontmatter.feature_image.childMarkdownRemark.html'
  | 'frontmatter.feature_image.childMarkdownRemark.htmlAst'
  | 'frontmatter.feature_image.childMarkdownRemark.excerptAst'
  | 'frontmatter.feature_image.childMarkdownRemark.headings'
  | 'frontmatter.feature_image.childMarkdownRemark.timeToRead'
  | 'frontmatter.feature_image.childMarkdownRemark.tableOfContents'
  | 'frontmatter.feature_image.childMarkdownRemark.children'
  | 'frontmatter.feature_image.id'
  | 'frontmatter.feature_image.parent.id'
  | 'frontmatter.feature_image.parent.children'
  | 'frontmatter.feature_image.children'
  | 'frontmatter.feature_image.children.id'
  | 'frontmatter.feature_image.children.children'
  | 'frontmatter.feature_image.internal.content'
  | 'frontmatter.feature_image.internal.contentDigest'
  | 'frontmatter.feature_image.internal.description'
  | 'frontmatter.feature_image.internal.fieldOwners'
  | 'frontmatter.feature_image.internal.ignoreType'
...
type TemplateIndexQuery = { readonly markdownRemark: Maybe<Pick<MarkdownRemark, 'html'>>, readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
...
type SiteMetaDataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl'>> }> };
...
type usePostsQueryVariables = Exact<{ [key: string]: never; }>;


type usePostsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'date'>
          & { readonly feature_image: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
        )>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'slug'>> } }> } };
