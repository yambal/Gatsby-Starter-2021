...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly topImage: Maybe<FileFilterInput>;
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.topImage.sourceInstanceName'
  | 'childrenMarkdownRemark.frontmatter.topImage.absolutePath'
  | 'childrenMarkdownRemark.frontmatter.topImage.relativePath'
  | 'childrenMarkdownRemark.frontmatter.topImage.extension'
  | 'childrenMarkdownRemark.frontmatter.topImage.size'
  | 'childrenMarkdownRemark.frontmatter.topImage.prettySize'
  | 'childrenMarkdownRemark.frontmatter.topImage.modifiedTime'
  | 'childrenMarkdownRemark.frontmatter.topImage.accessTime'
  | 'childrenMarkdownRemark.frontmatter.topImage.changeTime'
  | 'childrenMarkdownRemark.frontmatter.topImage.birthTime'
  | 'childrenMarkdownRemark.frontmatter.topImage.root'
  | 'childrenMarkdownRemark.frontmatter.topImage.dir'
  | 'childrenMarkdownRemark.frontmatter.topImage.base'
  | 'childrenMarkdownRemark.frontmatter.topImage.ext'
  | 'childrenMarkdownRemark.frontmatter.topImage.name'
  | 'childrenMarkdownRemark.frontmatter.topImage.relativeDirectory'
  | 'childrenMarkdownRemark.frontmatter.topImage.dev'
  | 'childrenMarkdownRemark.frontmatter.topImage.mode'
  | 'childrenMarkdownRemark.frontmatter.topImage.nlink'
  | 'childrenMarkdownRemark.frontmatter.topImage.uid'
  | 'childrenMarkdownRemark.frontmatter.topImage.gid'
  | 'childrenMarkdownRemark.frontmatter.topImage.rdev'
  | 'childrenMarkdownRemark.frontmatter.topImage.ino'
  | 'childrenMarkdownRemark.frontmatter.topImage.atimeMs'
  | 'childrenMarkdownRemark.frontmatter.topImage.mtimeMs'
  | 'childrenMarkdownRemark.frontmatter.topImage.ctimeMs'
  | 'childrenMarkdownRemark.frontmatter.topImage.atime'
  | 'childrenMarkdownRemark.frontmatter.topImage.mtime'
  | 'childrenMarkdownRemark.frontmatter.topImage.ctime'
  | 'childrenMarkdownRemark.frontmatter.topImage.birthtime'
  | 'childrenMarkdownRemark.frontmatter.topImage.birthtimeMs'
  | 'childrenMarkdownRemark.frontmatter.topImage.blksize'
  | 'childrenMarkdownRemark.frontmatter.topImage.blocks'
  | 'childrenMarkdownRemark.frontmatter.topImage.publicURL'
  | 'childrenMarkdownRemark.frontmatter.topImage.childrenImageSharp'
  | 'childrenMarkdownRemark.frontmatter.topImage.childrenMarkdownRemark'
  | 'childrenMarkdownRemark.frontmatter.topImage.id'
  | 'childrenMarkdownRemark.frontmatter.topImage.children'
  ...
  | 'childMarkdownRemark.frontmatter.topImage.sourceInstanceName'
  | 'childMarkdownRemark.frontmatter.topImage.absolutePath'
  | 'childMarkdownRemark.frontmatter.topImage.relativePath'
  | 'childMarkdownRemark.frontmatter.topImage.extension'
  | 'childMarkdownRemark.frontmatter.topImage.size'
  | 'childMarkdownRemark.frontmatter.topImage.prettySize'
  | 'childMarkdownRemark.frontmatter.topImage.modifiedTime'
  | 'childMarkdownRemark.frontmatter.topImage.accessTime'
  | 'childMarkdownRemark.frontmatter.topImage.changeTime'
  | 'childMarkdownRemark.frontmatter.topImage.birthTime'
  | 'childMarkdownRemark.frontmatter.topImage.root'
  | 'childMarkdownRemark.frontmatter.topImage.dir'
  | 'childMarkdownRemark.frontmatter.topImage.base'
  | 'childMarkdownRemark.frontmatter.topImage.ext'
  | 'childMarkdownRemark.frontmatter.topImage.name'
  | 'childMarkdownRemark.frontmatter.topImage.relativeDirectory'
  | 'childMarkdownRemark.frontmatter.topImage.dev'
  | 'childMarkdownRemark.frontmatter.topImage.mode'
  | 'childMarkdownRemark.frontmatter.topImage.nlink'
  | 'childMarkdownRemark.frontmatter.topImage.uid'
  | 'childMarkdownRemark.frontmatter.topImage.gid'
  | 'childMarkdownRemark.frontmatter.topImage.rdev'
  | 'childMarkdownRemark.frontmatter.topImage.ino'
  | 'childMarkdownRemark.frontmatter.topImage.atimeMs'
  | 'childMarkdownRemark.frontmatter.topImage.mtimeMs'
  | 'childMarkdownRemark.frontmatter.topImage.ctimeMs'
  | 'childMarkdownRemark.frontmatter.topImage.atime'
  | 'childMarkdownRemark.frontmatter.topImage.mtime'
  | 'childMarkdownRemark.frontmatter.topImage.ctime'
  | 'childMarkdownRemark.frontmatter.topImage.birthtime'
  | 'childMarkdownRemark.frontmatter.topImage.birthtimeMs'
  | 'childMarkdownRemark.frontmatter.topImage.blksize'
  | 'childMarkdownRemark.frontmatter.topImage.blocks'
  | 'childMarkdownRemark.frontmatter.topImage.publicURL'
  | 'childMarkdownRemark.frontmatter.topImage.childrenImageSharp'
  | 'childMarkdownRemark.frontmatter.topImage.childrenMarkdownRemark'
  | 'childMarkdownRemark.frontmatter.topImage.id'
  | 'childMarkdownRemark.frontmatter.topImage.children'
...
type MarkdownRemarkFieldsEnum =
  ...
  | 'frontmatter.title'
  | 'frontmatter.date'
  | 'frontmatter.topImage.sourceInstanceName'
  | 'frontmatter.topImage.absolutePath'
  | 'frontmatter.topImage.relativePath'
  | 'frontmatter.topImage.extension'
  | 'frontmatter.topImage.size'
  | 'frontmatter.topImage.prettySize'
  | 'frontmatter.topImage.modifiedTime'
  | 'frontmatter.topImage.accessTime'
  | 'frontmatter.topImage.changeTime'
  | 'frontmatter.topImage.birthTime'
  | 'frontmatter.topImage.root'
  | 'frontmatter.topImage.dir'
  | 'frontmatter.topImage.base'
  | 'frontmatter.topImage.ext'
  | 'frontmatter.topImage.name'
  | 'frontmatter.topImage.relativeDirectory'
  | 'frontmatter.topImage.dev'
  | 'frontmatter.topImage.mode'
  | 'frontmatter.topImage.nlink'
  | 'frontmatter.topImage.uid'
  | 'frontmatter.topImage.gid'
  | 'frontmatter.topImage.rdev'
  | 'frontmatter.topImage.ino'
  | 'frontmatter.topImage.atimeMs'
  | 'frontmatter.topImage.mtimeMs'
  | 'frontmatter.topImage.ctimeMs'
  | 'frontmatter.topImage.atime'
  | 'frontmatter.topImage.mtime'
  | 'frontmatter.topImage.ctime'
  | 'frontmatter.topImage.birthtime'
  | 'frontmatter.topImage.birthtimeMs'
  | 'frontmatter.topImage.blksize'
  | 'frontmatter.topImage.blocks'
  | 'frontmatter.topImage.publicURL'
  | 'frontmatter.topImage.childrenImageSharp'
  | 'frontmatter.topImage.childrenImageSharp.gatsbyImageData'
  | 'frontmatter.topImage.childrenImageSharp.id'
  | 'frontmatter.topImage.childrenImageSharp.children'
  | 'frontmatter.topImage.childImageSharp.gatsbyImageData'
  | 'frontmatter.topImage.childImageSharp.id'
  | 'frontmatter.topImage.childImageSharp.children'
  | 'frontmatter.topImage.childrenMarkdownRemark'
  | 'frontmatter.topImage.childrenMarkdownRemark.id'
  | 'frontmatter.topImage.childrenMarkdownRemark.excerpt'
  | 'frontmatter.topImage.childrenMarkdownRemark.rawMarkdownBody'
  | 'frontmatter.topImage.childrenMarkdownRemark.fileAbsolutePath'
  | 'frontmatter.topImage.childrenMarkdownRemark.html'
  | 'frontmatter.topImage.childrenMarkdownRemark.htmlAst'
  | 'frontmatter.topImage.childrenMarkdownRemark.excerptAst'
  | 'frontmatter.topImage.childrenMarkdownRemark.headings'
  | 'frontmatter.topImage.childrenMarkdownRemark.timeToRead'
  | 'frontmatter.topImage.childrenMarkdownRemark.tableOfContents'
  | 'frontmatter.topImage.childrenMarkdownRemark.children'
  | 'frontmatter.topImage.childMarkdownRemark.id'
  | 'frontmatter.topImage.childMarkdownRemark.excerpt'
  | 'frontmatter.topImage.childMarkdownRemark.rawMarkdownBody'
  | 'frontmatter.topImage.childMarkdownRemark.fileAbsolutePath'
  | 'frontmatter.topImage.childMarkdownRemark.html'
  | 'frontmatter.topImage.childMarkdownRemark.htmlAst'
  | 'frontmatter.topImage.childMarkdownRemark.excerptAst'
  | 'frontmatter.topImage.childMarkdownRemark.headings'
  | 'frontmatter.topImage.childMarkdownRemark.timeToRead'
  | 'frontmatter.topImage.childMarkdownRemark.tableOfContents'
  | 'frontmatter.topImage.childMarkdownRemark.children'
  | 'frontmatter.topImage.id'
  | 'frontmatter.topImage.parent.id'
  | 'frontmatter.topImage.parent.children'
  | 'frontmatter.topImage.children'
  | 'frontmatter.topImage.children.id'
  | 'frontmatter.topImage.children.children'
  | 'frontmatter.topImage.internal.content'
  | 'frontmatter.topImage.internal.contentDigest'
  | 'frontmatter.topImage.internal.description'
  | 'frontmatter.topImage.internal.fieldOwners'
  | 'frontmatter.topImage.internal.ignoreType'
  | 'frontmatter.topImage.internal.mediaType'
  | 'frontmatter.topImage.internal.owner'
  | 'frontmatter.topImage.internal.type'
...
type TemplatePostQuery = { readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<(
      ...
      & { readonly topImage: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
    )> }
  )> };
...
type UseSiteMetadataQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
